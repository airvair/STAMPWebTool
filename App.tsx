...
import ControlActionEnumeration from './components/step4_ControlActions/ControlActionEnumeration';
    ...
    <>
      <Routes>
        ...
        <Route element={<MainLayout />}>
          ...
          <Route path="/analysis/step4" element={<ControlActionEnumeration />} />
