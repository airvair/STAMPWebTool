...
import { UserFeedback, UserAction, ErrorHandler } from '@/utils/errorHandling';
    ...
    >
      <div className="flex items-start">
        ...
        <div className="ml-3 flex-1">
          <h3 className={`text-sm font-medium ${getTitleColorClasses()}`}>
            {feedback.title}
          </h3>
        ...
        <div className="ml-4 flex-shrink-0">
          <button
            ...
            className={`
              ...
              ${feedback.type === 'success' ? 'text-green-500 hover:bg-green-100 focus:ring-green-500 dark:text-green-400 dark:hover:bg-green-900/50' : ''}
              ${feedback.type === 'warning' ? 'text-yellow-500 hover:bg-yellow-100 focus:ring-yellow-500 dark:text-yellow-400 dark:hover:bg-yellow-900/50' : ''}
              ${feedback.type === 'error' ? 'text-red-500 hover:bg-red-100 focus:ring-red-500 dark:text-red-400 dark:hover:bg-red-900/50' : ''}
              ${feedback.type === 'info' ? 'text-blue-500 hover:bg-blue-100 focus:ring-blue-500 dark:text-blue-400 dark:hover:bg-blue-900/50' : ''}
            `}
          >
