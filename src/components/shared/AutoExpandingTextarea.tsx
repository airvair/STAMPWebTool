    ...
    <div className={cn('', containerClassName)}>
      ...
      <textarea
        ...
        className={cn(
          ...
          "bg-white dark:bg-slate-900/50 flex w-full rounded-md border px-3 py-1.5 text-base shadow-xs",
          "transition-[color,box-shadow,height] outline-none focus-visible:ring-[3px]",
          "disabled:cursor-not-allowed disabled:opacity-50 md:text-sm resize-none overflow-hidden",
          "leading-normal",
