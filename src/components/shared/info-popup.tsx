...
const InfoPopup: React.FC<InfoPopupProps> = ({ title, content, containerClassName = '' }) => {
  ...
  return (
    <div className={`inline-block align-middle ${containerClassName}`}>
      <button
        type="button"
        className="inline-flex items-center justify-center rounded-full bg-slate-800 px-1.5 py-1.5 text-sm font-medium text-slate-300 shadow-sm hover:bg-slate-700 focus:ring-2 focus:ring-sky-500 focus:ring-offset-2 focus:ring-offset-black focus:outline-none"
