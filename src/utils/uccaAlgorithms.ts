import { Controller, ControlAction, UnsafeControlAction, UCCA, UCCAType, PotentialUCCA } from '@/types/types';

export type AuthorityTuple = [string, string]; // [Superior, Subordinate]

// UCCAAlgorithmType is now imported from @/types/types
...
// PotentialUCCA and SpecialInteractions are now imported from @/types/types

export class UCCAIdentificationAlgorithm {
  private controllers: Controller[];
  private controlActions: ControlAction[];
  // @ts-ignore - Reserved for future use to check against existing UCAs
  private _existingUCAs: UnsafeControlAction[];
  ...
  constructor(
    ...
    this._existingUCAs = existingUCAs;
  }
