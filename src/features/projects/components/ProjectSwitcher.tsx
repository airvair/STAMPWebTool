...
const ProjectSwitcher: React.FC = () => {
  const { projects, currentProject, currentAnalysis, selectProject, createProject, updateProject, deleteProject } = useProjects();
  ...
  const handleRenameProject = () => {
    if (renamingProjectId && renameValue.trim()) {
      ...
      if (renamingProjectId === currentProject?.id) {
        const projectSlug = encodeURIComponent(renameValue.trim().toLowerCase().replace(/\s+/g, '-'));
