...
import { CausalScenario, ScenarioClass, UnsafeControlAction, ControllerType } from '../../types';
...
const CausalScenarios: React.FC = () => {
  ...
  if (ucas.length === 0) return <p className="text-slate-600">No Unsafe Control Actions (UCAs) defined. Please complete Step 5.</p>;
