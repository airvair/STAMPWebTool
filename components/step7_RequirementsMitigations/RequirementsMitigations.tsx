...
import { Requirement, CausalScenario, AnalysisType } from '../../types';
...
const RequirementsMitigations: React.FC = () => {
  ...
  if (scenarios.length === 0) return <p className="text-slate-600">No Causal Scenarios defined. Please complete Step 6.</p>;
