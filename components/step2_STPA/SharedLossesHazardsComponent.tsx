 ...
 */
const SharedLossesHazardsComponent: React.FC<SharedLossesHazardsComponentProps> = ({ analysisType }) => {
  const {
    ...
    hazards.forEach(hazard => {
      ...
      if (!existingConstraint) {
        addSystemConstraint({ 
          text: constraintText, 
          hazardId: hazard.id, 
          ...(analysisType === AnalysisType.STPA && { shallNotMustNot: newConstraintData.shallNotMustNot }) 
