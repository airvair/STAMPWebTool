...
const NewAnalysisButton: React.FC = () => {
  ...
  const handleCreateAnalysis = () => {
    ...
    createAnalysis(currentProject.id, selectedType, analysisName.trim());
    
    // Navigate to the first step of the analysis
    const firstStep = selectedType === AnalysisType.CAST ? CAST_STEPS[0].path : STPA_STEPS[0].path;
    navigate(firstStep);
